...
class Connection {
    ...
    private $appInfo = null;  // extra data member for application data for client
    ...
    private function handshake($data) {
        ...
        // trigger status application: nabg --- commented out
...
//		}
    ...
    private function handle($data) {
        ...
        // trigger status application:-- commented out
        //if($this->server->getApplication('status') !== false)
//		{
